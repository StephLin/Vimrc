...
sudo apt-get install -y vim git curl cmake build-essential python python3 python-dev python3-dev python-pip python3-pip powerline fonts-powerline libtinfo-dev
